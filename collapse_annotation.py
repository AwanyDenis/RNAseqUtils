...
# SCRIPT: collapse_annotation.py
# AUTHOR: South African Tuberculosis (SATVI) Bioanalytical Node; Adapted from Francois Aguet
# MAINTAINER: Denis Awany 
# DATE: 24/05/2021
# REV: 1.0
# PLATFORM: Linux
# DEPENDENCY: PYTHON
# PURPOSE: This is a script to collapse annotation on the GTF file, producing the union of transcripts for each gene.

# Usage: python3 collapse_annotation.py gencode.v38.annotation.gtf gencode.v38.annotation_collapsed_genes.gtf
# Requires that bx-python is installed. [python -m pip install bx-python] 
